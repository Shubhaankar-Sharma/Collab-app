      ...
      child: InkWell(
        ...
        child: AnimatedContainer(
          ...
          padding: EdgeInsets.symmetric(
            horizontal:
            (_currentState == ButtonState.SHOW_ONLY_ICON) ? 16.0 : 18.0,
            vertical: 8.0,
          ),
          child: AnimatedSize(
            vsync: this,
            ...
            child: Row(
              ...
              children: <Widget>[
                (_currentState == ButtonState.SHOW_ONLY_ICON ||
                  ...
                  color: widget.buttonStyle.buttoncolor,
                )
                    : Container(),
                SizedBox(
                  width: _currentState == ButtonState.SHOW_TEXT_ICON ? 0.0 : 0.0,
                ),
                getTextWidget()
              ],
            ),
...
class ButtonStyle {
  ...
  final Color primaryColor, secondaryColor , buttoncolor;
